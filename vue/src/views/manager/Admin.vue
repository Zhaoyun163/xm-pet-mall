<template>
  ...
  <div>
      ...
      <el-table :data="data.tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column label="头像" prop="avatar">
          <template #default="scope">
            <el-image v-if="scope.row.avatar" preview-teleported="true" :preview-src-list="[scope.row.avatar]" :src="scope.row.avatar"
    ...
    <el-dialog title="管理员信息" v-model="data.formVisible" width="500px" destroy-on-close>
