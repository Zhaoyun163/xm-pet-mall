    ...
    <div class="card" style="width: 60%;padding: 40px 30px">
      <el-form ref="formRef" :rules="data.rules" :model="data.form" label-width="80px" style="margin-top: 20px;margin-right: 50px;">
        ...
        <el-form-item label="手机号:" prop="phone">
          <el-input v-model="data.form.phone" placeholder="请输入手机号" autocomplete="off" maxlength="11" :rules="data.rules.phone"></el-input>
        </el-form-item>
        <el-form-item label="邮箱:" prop="email">
          <el-input v-model="data.form.email" placeholder="请输入邮箱" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="销售宠物:" prop="sellPet" v-if="data.user.role==='PETSHOP'">
        ...
        <el-form-item label="地址:" prop="address" v-if="data.user.role==='PETSHOP'">
          <el-input type="textarea" :rows="1" v-model="data.form.address" placeholder="请输入地址" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="介绍:" prop="introduce" v-if="data.user.role==='PETSHOP'">
